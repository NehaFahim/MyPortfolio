...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Backend API Call (Replace with your backend endpoint)
  ...
  {/* Twitter/X Icon */}
  <a href="https://x.com/FahimNeha33515" className="group">
    <div className="bg-white/5 p-4 rounded-full border border-white/10 transition duration-300 group-hover:border-white group-hover:scale-110">
      ...
      {/* GitHub Icon */}
  <a href="https://github.com/NehaFahim" className="group">
  ...
  {/* LinkedIn Icon */}
  <a href="https://www.linkedin.com/in/nehafahim/" className="group">
